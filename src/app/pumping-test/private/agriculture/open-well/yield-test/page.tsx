  ...
  const onSubmit = (values: FormValues) => {
    ...
    startTransition(() => {
      ...
      const reportData = {
        ...
        purpose: "Pumping Test / Private / Agriculture / Open Well",
        category: "Pumping Test / Private / Agriculture / Open Well",
        testType: 'PYT',
        uploadedBy: user.uid,
    ...
    <div className="p-4 sm:p-6">
       <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" asChild>
          <Link href="/pumping-test/private/agriculture">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 border-t mt-6">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Button asChild variant="outline" size="sm" disabled={!generatedReportId} className="h-9 text-[10px] font-bold uppercase tracking-wider border-primary/20 text-primary">
                <Link href={generatedReportId ? `/pumping-test/private/agriculture/open-well/yield-test/completion-report?id=${generatedReportId}` : '#'} target="_blank">
