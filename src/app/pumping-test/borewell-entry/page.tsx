          ...
          <div className="h-[500px] w-full">
            <Table>
                <TableHeader className="bg-slate-100/50 sticky top-0 z-20">
                  ...
                  <TableRow className="bg-slate-50/50 text-[9px] uppercase font-black h-8">
          ...
          <div className="flex items-center gap-4 pl-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">PUMPING TEST (BOREWELL)</span>
