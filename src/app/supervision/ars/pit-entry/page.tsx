      ...
      <Card className="rounded-[40px] border-none shadow-sm ring-1 ring-slate-200 overflow-hidden bg-white">
        ...
        <CardContent className="p-10 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="space-y-2">
              <Label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Ward No</Label>
              <Input disabled={!isAllowed} value={formData.ward || ''} onChange={(e) => updateField('ward', e.target.value)} className="h-11 border-slate-200" />
            </div>
            <div className="space-y-2">
        ...
        <CardContent className="p-10 space-y-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-2">
              ...
              <Input disabled={!isAllowed} type="text" value={formData.depthOfPit || ''} onChange={(e) => updateField('depthOfPit', e.target.value)} className="h-11 border-slate-200 font-bold" />
            </div>
            <div className="space-y-2">
