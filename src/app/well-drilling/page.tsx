          ...
          <DropdownMenuContent align="end" className="w-[300px] p-2 rounded-[24px] border-slate-200 shadow-2xl">
            ...
            <DropdownMenuItem asChild className="rounded-xl cursor-pointer p-3 focus:bg-emerald-50 group">
              <Link href="/well-drilling/flushing-entry" className="flex items-center gap-3">
                <div className="p-2 bg-emerald-100 rounded-lg group-focus:bg-emerald-200"><Wind className="size-4 text-emerald-600" /></div>
            ...
            <Table>
              ...
              <TableBody>
                {isLoading ? (
                  ...
                  <TableRow><TableCell colSpan={5} className="h-64 text-center opacity-20"><FilterX className="size-16 mx-auto mb-4" /><p className="font-black uppercase text-sm">No drilling logs found</p></TableCell></TableRow>
                )}
              </TableBody>
            </Table>
          </div>
